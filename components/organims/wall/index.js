    ...
    return (
        <div>
            ...
            <div className="md:float-right sm:float-none py-6 ">
                  <Link href="profile" >
                  <button  type="submit" className=" rounded-xl mt-5 p-3 text-white text-sm bg-blue-medium hover:bg-blue-medium focus:outline-none focus:bg-blue-700 duration-300">Perfil</button>
                  </Link>
