...
export default function createAccount() {
	...
	const isInvalid =
		email === '' || password === '' || nombre === '' || apellido ==='' || dia === '00' || mes === '00' || ano === '00' || sexo==='';
				...
				<div className="md:flex w-full text-center">
					...
					>
						...
						<div className="w-full ml-56  text-center">
							<h1 className="text-5xl text-center font-bold  tracking-wide text-indigo-primary">Registrate</h1>
							<p className="text-2xl  mt-80 text-white">
								Al hacer Click en "Registrate" aceptas nuestras condiciones y politicas. te enviaremos
								un correo eletronico de activacion
							</p>
						</div>
					</div>
					...
					<div className="w-full md:w-1/2 py-1 px-1 md:px-10">
						<div className="text-center mb-10 text-indigo-primary" >
							<h1 className="font-bold text-3xl text-indigo-primary">CREAR CUENTA</h1>
                        ...
                        <div>
							...
							<div className="mb-1 -mx-2  flex items-end">
								<div className="px-2 w-1/2 ">
									<label className="font-bold text-sm mb-1 ml-1">Fecha de Cumpleaños</label>
									<div>
										<select
							...
							<div className="flex -mx-3 mt-8">
								<div className="w-full px-3 mb-5">
									<button disabled={isInvalid} className={`block w-full max-w-xs mx-auto bg-indigo-primary hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold ${isInvalid && 'opacity-50'} `}>
										REGÍSTRATE AHORA
									</button>
								</div>
							</div>
                            ...
                            <Link href="/">
								<p className="mt-8">
									{' '}
									¿Ya tienes{' '}
									<a href="#" className="text-indigo-primary hover:text-blue-700 font-semibold">
										una cuenta?
									</a>
								</p>
							</Link>
